...
func (_ *Manager) ParseCmd(flags *flag.FlagSet) {
	...
	// Default is 20GiBs for free tier. Hence use it as default
	flags.IntVar(&alibabacloudcfg.SystemDiskSize, "system-disk-size", 20, "System Disk size (in GiB) for the Pod VMs")
